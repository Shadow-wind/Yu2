        ...
        <div class="tabs">
            ...
            <div id="content-6" class="content-form wrapper">
                <form  name="extradition" method="post" action="">
                    ...
                    <input class="text-field__input" type="search" name="search" placeholder="ФИО" >
                    <label class="text-field__label" for="search">Айди</label>
                    <input class="text-field__input" type="search" name="search" placeholder="Айди" >
                ...
                <table>
                    <?php 
                        $data = $mysqli_query($conn, "SELECT * FROM users WHERE surname='$inputNHuman' AND idusers='$inputIdHuman'");
                       
                        foreach($data as $item){
                            echo "<tr>
                                <td>'$item'->'idusers'</td>
                                <td>'$item'->'surname'</td>
                                <td>'$item'->'name_imia'</td>
                                <td>'$item'->'patronymic'</td>
                                <td>'$item'->'passport'</td>
                                <td>'$item'->'number_tel'</td>
                                <td>'$item'>'address_adresэ'</td>
            ...
            <div id="content-7" class="content-form wrapper">
                    ...
                    <form name="extradition" method="post" action=" " >
                        <div class="text_field login form_grid ">
                            ...
                            <input class="text-field__input" type="text" name="f_title value=""
